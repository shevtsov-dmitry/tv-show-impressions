...
INSERT INTO genre (language_code, name, displayed_by_default)
VALUES ('en', 'Drama', true),
       ('ru', 'Драма', true),
       ('en', 'Melodrama', true),
       ('ru', 'Мелодрама', true),
       ('en', 'Comedy', true),
       ('ru', 'Комедия', true),
       ('en', 'Biographical', true),
       ('ru', 'Биография', true),
       ('en', 'Detective', true),
       ('ru', 'Детектив', true),
       ('en', 'Sport', true),
       ...
       ('ru', 'Ужасы', true),
       ('en', 'ShortFilm', true),
       ('ru', 'Короткометражный фильм', true),
       ('en', 'War', true),
       ('ru', 'Военный', true),
       ('en', 'ForKids', true),
       ('ru', 'Для детей', true),
